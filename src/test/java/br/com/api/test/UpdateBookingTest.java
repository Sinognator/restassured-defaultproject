...
public class UpdateBookingTest {
    ...
    public void updateBooking(){
        ...
        reserva.firstname = "João Atualização";
        Booking reservaAtualizada = BookingClient.atualizarReserva(id, reserva, token);
        assertEquals("João Atualização", reservaAtualizada.firstname);
    }
}
